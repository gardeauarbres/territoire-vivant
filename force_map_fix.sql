-- 1. Ensure RLS is enabled (or re-enable to reset)
...
DROP POLICY IF EXISTS "Public Select" ON zones;

-- 3. Create a clearly permissive policy for SELECT
...
-- 5. Insert Data (guaranteed valid)
